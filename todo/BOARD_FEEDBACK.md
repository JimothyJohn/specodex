...
| Item | Status |
|---|---|
| 1. README brand cleanup | ✅ shipped 2026-05-09 (this PR) |
| 2. PUBLIC.md continuity plan | ✅ shipped 2026-05-09 (folded into PUBLIC.md, this PR) |
| 3. Public data / takedown policy | ✅ shipped 2026-05-09 (folded into PUBLIC.md, this PR) |
| 4. Email five manufacturers | ⏳ not started — founder must do personally; PUBLIC.md gives the email a link to point at |
| 5. First paid tier price + features | ⏳ not started — decision, then Stripe wiring |
| 6. Customer-conversation log | ⏳ not started — private to founder, not in repo |
| 7. Ship-hours / talk-hours ratio | ⏳ not started — private to founder, not in repo |
| 8. Data-provenance affordances | ⏳ not started — model + UI change, larger than 1 day |
| 9. Decisions to write down | ⏳ not started — beachhead, engineer-direct vs B2B2C, "not this quarter" |

The shipped items (1+2+3) are pure-additive doc work and unblock item 4 (the manufacturer-outreach email links to PUBLIC.md). Item 8 is the only "easy-looking" one that's bigger than a day; the rest are founder-driven decisions or recurring disciplines that no PR can close.
