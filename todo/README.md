...
| `specodex/configurators/**`, `cli/configurator.py`; user asks "configurator harvest", "scrape a configurator", "reverse a part number from a vendor tool", "cross-reference catalog vs configurator" | [CONFIGURATOR_HARVEST.md](CONFIGURATOR_HARVEST.md) — planned; Stober spike proven 2026-07-25 |
