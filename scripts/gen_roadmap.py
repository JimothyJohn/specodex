    ...
    <main>
        <section class="hero">
            ...
            <p class="hero-sub">
                ...
                truth lives in <a href="https://github.com/JimothyJohn/specodex/tree/master/todo" rel="noreferrer"><code>todo/</code></a>;
                regenerate with <code>uv run python scripts/gen_roadmap.py</code>.
                Click a card to open the full plan.
            </p>
        </section>
